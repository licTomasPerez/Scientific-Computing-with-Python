...
This is my commented attempted solution to FreeCodeCamp's Scientific-Computing With Python's fifth project: Probability Calculator.

My solution is based on Landon Schlangen's solution. 
